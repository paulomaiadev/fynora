...
const BudgetForm = () => {
  ...
  const { addBudget, getBudgetById, updateBudget, isLoading } = useBudgetStore();
                    ...
                    {items.map((item, index) => (
                      ...
                      >
                        ...
                        <div className="col-span-2">
                          {index === 0 && <Label className="mb-2 block text-xs">Qtd</Label>}
                          <Input
                            type="number"
                            min="1"
                            value={item.quantity}
                        ...
                        <div className="col-span-2">
                          {index === 0 && <Label className="mb-2 block text-xs">Total</Label>}
                          <Input
